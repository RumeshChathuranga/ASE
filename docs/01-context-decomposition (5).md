...
| Field | Value |
|---|---|
| Document | 01-context-decomposition.md |
| Section Owner | Member 1 |
| Part of | UrbanRide ADD (5-section document) |
| Diagram | C4 Level 1 — System Context |
| Status | Final — ready for team consistency review |
| Traces to | FROZEN.md |
...
Internal services do not appear at Level 1 — see Section 1.9 for the diagram deliverable. Internal decomposition begins at Level 2, covered in Section 3 (Communication & Streaming, Member 3).
...
*Data-store rationale is owned by Section 2 (Data Design & Transactions, Member 2) — this column is a cross-reference, not a duplicate decision.*
